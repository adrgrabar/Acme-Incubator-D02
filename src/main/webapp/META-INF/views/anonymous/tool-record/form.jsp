...
<acme:form>
	...
	<acme:form-url code="anonymous.toolRecord.form.label.inventor" path="inventor"/>
	<acme:form-moment code="anonymous.toolRecord.form.label.description" path="description"/>
	<acme:form-moment code="anonymous.toolRecord.form.label.webSite" path="webSite"/>
